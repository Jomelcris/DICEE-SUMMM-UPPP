...
public class GameModeScreen extends JPanel {
    ...
    private static final String BG_PATH = "assets/background_gamemode.png";
    private static final String BTN_PVP_PATH  = "assets/btn_pvp.png";
    private static final String BTN_PVC_PATH  = "assets/btn_pvc.png";
    private static final String BTN_ARC_PATH  = "assets/btn_arcade.png";
